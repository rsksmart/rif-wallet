...
export const loadExistingWallets = (createRIFWallet: CreateRIFWallet) => async () => {
...
export const creteKMS = (createRIFWallet: CreateRIFWallet, networkId: number) => async (mnemonic: string) => {
