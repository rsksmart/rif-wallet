...
const ReceiveIcon: React.FC<{ color?: string }> = ({ color }) => (
...
export const ReceiveButton: React.FC<IconButtonInterface> = props => (
  <SquareButton {...props} icon={<ReceiveIcon color={props.color} />} />
)
