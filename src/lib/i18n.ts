...
const resources = {
  en: {
    translation: {
      ...
      request_username_summary_title: 'Purchase username',
      request_username_congratulations_title: 'Congratulations!',
      request_username_congratulations_subtitle:
        'You have requested your domain.',
      request_username_congratulations_description:
